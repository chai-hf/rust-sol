...
pub trait FenwickMut: IndexMut<usize>
where
    Self::Output: Copy + AddAssign + SubAssign,
{
    #[inline]
...
impl<T: Index<usize> + ?Sized> Fenwick for T where Self::Output: Copy + AddAssign + SubAssign {}
impl<T: IndexMut<usize> + ?Sized> FenwickMut for T where Self::Output: Copy + AddAssign + SubAssign {}
